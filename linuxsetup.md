...
|**CPU处理器**：P4 Xeon 2.4G*2 内存: 8G及以上|**CPU处理器**：INTEL 或AMD处理器2.0GHz以上内存: 4GB及以上|**CPU处理器**：INTEL 或AMD处理器4.0GHz以上内存: 4GB及以上|**CPU处理器**：INTEL 或AMD处理器4.0GHz以上内存: 2GB及以上|**CPU处理器**：INTEL 或AMD处理器1.2GHz以上||
