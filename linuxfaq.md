...
**解决方法**： 
   * 根据实际情况处理，在保证行情源正常的情况下，按[这里](http://qlfaq.com/#!sysdata.md#Linux系统补实时数据的操作步骤)的步骤补实时数据。
...
**解决方法**：
按[这里](http://qlfaq.com/#!sysdata.md#Linux系统补日线的操作步骤)的步骤补历史数据   
```
